                        ...
                        <ul class="contacts">
                            ...
                            <li class="active dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('img/avatar/1.jpg') }}" class="rounded-circle user_img" alt=""/>
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('img/avatar/2.jpg') }}" class="rounded-circle user_img" alt=""/>
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('img/avatar/3.jpg') }}" class="rounded-circle user_img" alt=""/>
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('img/avatar/4.jpg') }}" class="rounded-circle user_img" alt=""/>
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('img/avatar/5.jpg') }}" class="rounded-circle user_img" alt=""/>
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                    ...
                    <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                                <img src="{{ asset('img/avatar/1.jpg') }}" class="rounded-circle user_img_msg" alt=""/>
                            </div>
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            ...
                            <div class="img_cont_msg">
                        <img src="{{ asset('img/avatar/2.jpg') }}" class="rounded-circle user_img_msg" alt=""/>
                            </div>
                        </div>
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            ...
                            @php
                                $allNotis = count($notificaciones);
                                if ($allNotis > 0) {
                                    echo '<span class="badge light text-white bg-danger">'. $allNotis .'</span>';
                                }
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
                                <ul class="timeline">
                                    @php
                                            if ($allNotis == 0) {
                                                echo '<li><h5>Sin notificaciones</h5></li>';
                                            }
                                        for ($i=0; $i < count($notificaciones); $i++) {
                                            $detalle = json_decode($notificaciones[$i]['data'], true);

                                            echo '<a href="';

                                            switch ($detalle['titulo']) {
                                                case 'Solicitud de consulta.':
                                                    echo '../citas';
                                                    break;
                                            ...
                                            echo '" style="text-decoration: none; color: #333"><li>
                                                    <div class="timeline-panel">
                                                        <div class="media mr-2">
                                                            <img alt="image" width="50" src="'.  asset('img/avatar/1.jpg') . '">
                                                        </div>
                                                        <div class="media-body">
                                                            <h6 class="mb-1">' . $detalle['titulo'] . '</h6>
                                                            <small class="d-block">' . $detalle['detalle'] . '</small>
                                                            <small class="d-block">' . $detalle['tipo'] . '</small>
                                                        </div>
                                                    </div>
                                                </li></a>';
                                        }
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            ...
                            @php
                                $getAvatar = DB::table('user_upload_images')->where('customer_id', '=', Auth::user()->id)->where('type', '=', 'avatar')->orderBy('created_at', 'DESC')->get();
