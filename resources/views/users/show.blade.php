...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="form-head page-titles d-flex align-items-center mb-sm-4 mb-3">
            <div class="mr-auto">
                <h2 class="text-black font-w600">Detalles del paciente</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Paciente</a></li>
            ...
            <div class="d-flex">
                ...
                <a href="app-profile.html" class="btn btn-outline-primary">Actualizar información</a>
            </div>
        </div>
        <div class="row">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card details-card">
                            <img src="{{ asset('img/bg.jpg') }}" alt="" class="bg-img">
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media mb-4 align-items-center">
                                    <img src="{{ asset('img/users/12.jpg') }}" alt="" width="85" class="mr-3">
                                    <div class="media-body">
